  ...
  describe ".handle_buffer/4" do
    ...
    context "queue is empty" do
      ...
      context "frame is contained in the buffer" do
        let :frame,
          do:
            <<255, 243, 20, 196, 0, 0, 0, 3, 72, 0, 0, 0, 0, 76, 65, 77, 69, 51, 46, 57, 54, 46,
              49, 85, 255, 243, 20, 196, 11, 0, 0, 3, 72, 0, 0, 0, 0, 85, 85, 85, 85, 85, 85, 85,
              85, 85, 85, 85, 255, 243, 20, 196, 22, 0, 0, 3, 72, 0, 0, 0, 0, 85, 85, 85, 85, 85,
              85, 85, 85, 85, 85, 85, 255, 243, 20, 196, 33, 0, 0, 3, 72, 0, 0, 0, 0, 85, 85, 85,
              85, 85, 85, 85, 85, 85, 85, 85>>

        it "shoud return ok tuple" do
          {{result_atom, _decoded}, _new_state} =
            described_module().handle_process1(:sink, buffer(), %{caps: caps()}, state())

          expect(result_atom) |> to(eq(:ok))
        end

        it "should return non empty result" do
          {{_result_atom, [buffer: {:source, %Membrane.Buffer{payload: decoded}}]}, _new_state} =
            described_module().handle_process1(:sink, buffer(), %{caps: caps()}, state())
    ...
    context "queue is not empty" do
      ...
      context "frame is contained in the queue and buffer" do
        let :frame,
          do:
            <<0, 0, 0, 76, 65, 77, 69, 51, 46, 57, 54, 46, 49, 85, 255, 243, 20, 196, 11, 0, 0, 3,
              72, 0, 0, 0, 0, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 255, 243, 20, 196, 22,
              0, 0, 3, 72, 0, 0, 0, 0, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 255, 243, 20,
              196, 33, 0, 0, 3, 72, 0, 0, 0, 0, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85, 85>>
